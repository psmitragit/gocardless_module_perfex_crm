    ...
    <div class="col-md-12">
        <div class="tw-bg-neutral-50 tw-rounded-md tw-p-6 tw-border tw-border-solid tw-border-neutral-200 tw-mb-4">
            <div class="form-group select-placeholder">
                ...
                <select id="stripe_plan_id" name="stripe_plan_id" class="selectpicker" data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('stripe_subscription_select_plan'); ?>">
                    <option value=""></option>
                    <?php foreach ($plans as $l) : ?>
                        <option value="<?= $l->id; ?>"><?= $l->name; ?> $<?= $l->amount . '/' . $l->interval; ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
        ...
        <div class="form-group">
            <div class="checkbox checkbox-primary">
                ...
                <label for="description_in_item"><i class="fa-regular fa-circle-question" data-toggle="tooltip" data-title="<?php echo _l('description_in_invoice_item_help'); ?>"></i>
        ...
        <div class="form-group select-placeholder f_client_id">
            ...
            <select id="clientid" name="clientid" data-live-search="true" data-width="100%" class="ajax-search ays-ignore" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>" <?php if (isset($subscription) && !empty($subscription->stripe_subscription_id)) {
                                                                                                                                                                                                        echo ' disabled';
                                                                                                                                                                                                    } ?>>
                ...
                <div class="form-group select-placeholder">
                    ...
                    <select class="selectpicker" data-width="100%" name="stripe_tax_id" data-none-selected-text="<?php echo _l('no_tax'); ?>">
                        ...
                        <?php foreach ($stripe_tax_rates->data as $tax) {
                            ...
                            <option value="<?php echo e($tax->id); ?>" data-subtext="<?php echo !empty($tax->country) ? $tax->country : ''; ?>" <?php if (isset($subscription) && $subscription->stripe_tax_id == $tax->id) {
                                                                                                                                                    echo ' selected';
                                                                                                                                                } ?>>
                ...
                <div class="form-group select-placeholder">
                    ...
                    <select class="selectpicker" data-width="100%" name="stripe_tax_id_2" data-none-selected-text="<?php echo _l('no_tax'); ?>">
                        ...
                        <?php foreach ($stripe_tax_rates->data as $tax) {
                            ...
                            <option value="<?php echo e($tax->id); ?>" data-subtext="<?php echo !empty($tax->country) ? $tax->country : ''; ?>" <?php if (isset($subscription) && $subscription->stripe_tax_id_2 == $tax->id) {
                                                                                                                                                    echo ' selected';
                                                                                                                                                } ?>>
                                <?php echo e($tax->display_name); ?>
                                <?php echo !empty($tax->jurisdiction) ? ' - ' . $tax->jurisdiction . ' ' : ''; ?>
...
<?php if ((isset($subscription) && staff_can('edit',  'subscriptions')) || !isset($subscription)) { ?>
    <div class="btn-bottom-toolbar text-right">
        <button type="submit" class="btn btn-primary" data-loading-text="<?php echo _l('wait_text'); ?>" data-form="#subscriptionForm">
            <?php echo _l('save'); ?>
        </button>
    </div>
<?php } ?>
