            ...
            <div class="col-md-12">
                <div class="_buttons">
                    <?php if (staff_can('create',  'subscriptions')) { ?>
                        <a href="<?php echo admin_url('gocardless/subscriptions/create'); ?>" class="btn btn-primary pull-left display-block">
                            <i class="fa-regular fa-plus tw-mr-1"></i>
                            <?php echo _l('new_subscription'); ?>
                        </a>
                    <?php } ?>
                    <div id="vueApp" class="tw-inline pull-right tw-ml-0 sm:tw-ml-1.5">
                        <app-filters id="<?php echo $table->id(); ?>" view="<?php echo $table->viewName(); ?>" :saved-filters="<?php echo $table->filtersJs(); ?>" :available-rules="<?php echo $table->rulesJs(); ?>">
                        </app-filters>
                    </div>
                </div>
                ...
                <div class="panel_s tw-mt-2 sm:tw-mt-4">
                    <div class="panel-body">
                        ...
                        <div class="panel-table-full">
                            ...
                            <?php
                            $this->load->view('admin/table_html', [
                                'url' => admin_url('gocardless/subscriptions/table')
                            ]);
                            ?>
                        </div>
                    </div>
